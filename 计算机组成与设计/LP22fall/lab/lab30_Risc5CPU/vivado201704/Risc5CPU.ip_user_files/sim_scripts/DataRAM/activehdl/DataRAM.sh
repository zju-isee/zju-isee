...
#
# Generated by Vivado on Fri Dec 30 19:45:07 +0800 2022
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Desktop/COD_Lab/lab30_Risc5CPU/vivado201704/Risc5CPU.cache/compile_simlib/activehdl"
  fi
